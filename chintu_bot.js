...
const CONFIG = {
    prefix: '.',
    adminNumber: '919412185706', // YOUR NUMBER with country code (91 for India) NO + sign
    botName: 'Chintu Bot',
    emojiReactions: true,
};
...
async function connectToWhatsApp() {
    ...
    try {
        ...
        console.log('========================================');
        console.log('📱 Phone number:', CONFIG.adminNumber);
        ...
        try {
            // Generate pairing code with proper format
